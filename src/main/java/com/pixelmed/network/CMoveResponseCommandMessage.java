 ...
 * @author	dclunie
 */
public class CMoveResponseCommandMessage implements CommandMessage {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/CMoveResponseCommandMessage.java,v 1.11 2017/01/24 10:50:44 dclunie Exp $";
	...
	public CMoveResponseCommandMessage(String affectedSOPClassUID,
		...
		commandField = MessageServiceElementCommand.C_MOVE_RSP;
...
//System.err.println("CMoveResponseCommandMessage: bytes="+HexDump.dump(bytes));
	}
