...
public class AnyExplicitStoreFindMoveGetPresentationContextSelectionPolicy implements PresentationContextSelectionPolicy {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/AnyExplicitStoreFindMoveGetPresentationContextSelectionPolicy.java,v 1.5 2017/01/24 10:50:44 dclunie Exp $";
