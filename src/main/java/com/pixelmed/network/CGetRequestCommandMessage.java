...
public class CGetRequestCommandMessage extends RequestCommandMessage {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/CGetRequestCommandMessage.java,v 1.7 2017/01/24 10:50:44 dclunie Exp $";
