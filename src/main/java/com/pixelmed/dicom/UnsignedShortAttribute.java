...
public class UnsignedShortAttribute extends Attribute {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/UnsignedShortAttribute.java,v 1.23 2017/01/24 10:50:39 dclunie Exp $";
	...
	public float[] getFloatValues() throws DicomException {
		if (cachedFloatCopy == null) cachedFloatCopy=ArrayCopyUtilities.copyUnsignedShortToFloatArray(values);
	...
	public double[] getDoubleValues() throws DicomException {
		if (cachedDoubleCopy == null) cachedDoubleCopy=ArrayCopyUtilities.copyUnsignedShortToDoubleArray(values);
