...
/**
 * <p>This class represents laterality concepts that may be encoded and displayed.</p>
 * 
 * @author	dclunie
 */
public class DisplayableLateralityConcept extends DisplayableConcept {

	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/anatproc/DisplayableLateralityConcept.java,v 1.6 2017/01/24 10:50:32 dclunie Exp $";
	
	/**
	 * <p>Create a laterality concept that may be encoded and displayed.</p>
	 *
