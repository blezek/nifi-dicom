...
public class DICOMTransferTest {
	...
	public void someRejected() throws IOException, GeneralSecurityException {
		...
		putDICOM.enqueue("I am not a DICOM file!");
		InputStream r;
		r = getClass().getResourceAsStream("/Denoising/CTE_4/Axial/IM-0002-0001.dcm");
		putDICOM.enqueue(r);
		r = getClass().getResourceAsStream("/Denoising/CTE_4/Axial/IM-0002-0002.dcm");
		putDICOM.enqueue(r);
		r = getClass().getResourceAsStream("/Denoising/CTE_4/Axial/IM-0002-0003.dcm");
		putDICOM.enqueue(r);
